        ...
        <div class="container">
            <section class="main-offer-section">
                <div class="main-offer-info">
                    <h1 class="offer-title">Special Offers</h1>
                    <p>Discover unbeatable deals with our flight booking website's special offers, featuring exclusive
                        discounts on international and domestic flights. Book now and enjoy up to 50% off on selected
                        routes, plus added perks like free seat selection and extra baggage allowance.</p>
                </div>
                    ...
                    <div class="offer-card">
                        ...
                        <div class="offer-card-details">
                            <div class="offer-card-title">
                                <a href="#">
                                    <h4>Known momument in the black hills of south</h4>
                                </a>
                            </div>
            ...
            <section class="main-benefits-section">
                <div class="main-benefits-info">
                    <h1 class="offer-title">Our Benefit</h1>
                    <p>Discover unbeatable deals with our flight booking website's special offers, featuring exclusive
                        discounts on international and domestic flights. Book now and enjoy up to 50% off on selected
                        routes, plus added perks like free seat selection and extra baggage allowance.</p>
                </div>
                    ...
                    <div class="benefit-card">
                        ...
                        <div class="benefit-info">
                            <p>The point of using Lorem Ipsum is that it has a more-or-less normal distribution of
                                letters, making it look like readable English.</p>
                        </div>
                    </div>
            ...
            <section class="main-news-section">
                <div class="main-news-left">
                    <h1 class="offer-title">News Latest</h1>
                        ...
                        <div class="aside-news">
                            <a href="#">
                                ...
                                <div class="aside-news-right">
                                    ...
                                    <h4 class="aside-news-right--title">The point of using Lorem Ipsum is that it has...
                                    </h4>
                                </div>
                            </a>
                        </div>
                ...
                <div class="main-news-right">
                    <div class="offer-card">
                        ...
                        <div class="offer-card-details">
                            ...
                            <div class="offer-card-info">
                                <div class="offer-card-left news-card-info">
                                    Travel | By Admin
                                </div>
                            </div>
                            <div class="offer-card-title">
                                <a href="#">
                                    <h4>The point of using Lorem Ipsum is that it has...
                                    </h4>
                                </a>
                            </div>
                        </div>
                ...
                <div class="footer-top">
                    ...
                    <div class="footer-info">
                        <p>Nullam ultrices tortor non diam ullamcorper auctor. In urna tellus, auctor sit amet est ut,
                            scelerisque volutpat diam.</p>
                    </div>
                    <div class="footer-social-links">
                        <ul class="footer-all-social-links">
                            <li class="footer-social-link"><a href="#"><i class="fa-brands fa-facebook-f"></i></a></li>
                            <li class="footer-social-link"><a href="#"><i class="fa-brands fa-x-twitter"></i></a></li>
                            <li class="footer-social-link"><a href="#"><i class="fa-brands fa-youtube"></i></a></li>
                            <li class="footer-social-link"><a href="#"><i class="fa-brands fa-tiktok"></i></a></li>
                        </ul>
                    </div>
                </div>
